...
public interface TabelaDao
{
    ...
    @Query("DELETE FROM tabela WHERE YearOfOvertime = :year AND MonthOfOvertime = :month AND DayOfOvertime = :day" )
    ...
    @Query("UPDATE tabela SET YearOfOvertime = :newYear, MonthOfOvertime = :newMonth, DayOfOvertime = :newDay, Day = :dayOfWeek WHERE uid = :id")
    ...
    @Query("SELECT COUNT(*) FROM tabela WHERE YearOfOvertime = :year AND MonthOfOvertime = :month AND DayOfOvertime = :day")
